...
Begin VB.UserControl ucÂY»ë¤¶­±_½d¨Ò 
   Appearance      =   0  '¥­­±
   AutoRedraw      =   -1  'True
   BackColor       =   &H80000005&
   BackStyle       =   0  '³z©ú
   ...
   Begin ImageX.aicAlphaImage dice1 
      ...
      _ExtentX        =   1323
      _ExtentY        =   1323
      Image           =   "ucÂY»ë¤¶­±_½d¨Ò.ctx":FCA1
      Props           =   13
   End
   Begin ImageX.aicAlphaImage person2 
      Height          =   5190
      Left            =   5520
      Top             =   960
      Visible         =   0   'False
   ...
   Begin ImageX.aicAlphaImage person 
      ...
      _ExtentX        =   9340
      _ExtentY        =   9155
      Image           =   "ucÂY»ë¤¶­±_½d¨Ò.ctx":361BB
      Scaler          =   3
      Props           =   9
   End
End
Attribute VB_Name = "ucÂY»ë¤¶­±_½d¨Ò"
