                ...
                Select Case commadstr2(0)
                     ...
                     '=======================================================
                        ...
                        Case "PersonAtkingOff"
                               執行指令集.執行指令_禁止執行人物主動技技能_整體 uscom, commadtype, atkingnum  '(階段1)
                        Case "PersonPassiveOff"
                               執行指令集.執行指令_禁止執行人物被動技技能_整體 uscom, commadtype, atkingnum  '(階段1)
                        Case "PersonAtkingOffSelect"
                               執行指令集.執行指令_禁止執行人物主動技技能_選擇 uscom, commadtype, atkingnum  '(階段1)
                        Case "PersonPassiveOffSelect"
                               執行指令集.執行指令_禁止執行人物被動技技能_選擇 uscom, commadtype, atkingnum  '(階段1)
...
End Sub
Sub 執行指令_禁止執行人物主動技技能_整體(ByVal uscom As Integer, ByVal commadtype As Integer, ByVal atkingnum As Integer)
    If Formsetting.checktest.Value = 0 Then On Error GoTo vss_cmdlocalerr
    commadstr3 = Split(vbecommadstr(3, vbecommadtotplay), ",")
...
End Sub
Sub 執行指令_禁止執行人物被動技技能_整體(ByVal uscom As Integer, ByVal commadtype As Integer, ByVal atkingnum As Integer)
    If Formsetting.checktest.Value = 0 Then On Error GoTo vss_cmdlocalerr
    commadstr3 = Split(vbecommadstr(3, vbecommadtotplay), ",")
    If UBound(commadstr3) <> 2 Or (commadtype <> 1 And vbecommadnum(4, vbecommadtotplay) <> 61) Or atkingnum <= 8 Then GoTo VssCommadExit
    Select Case vbecommadnum(2, vbecommadtotplay)
...
Exit Sub
vss_cmdlocalerr:
執行指令集.執行指令集_錯誤訊息通知 "PersonPassiveOff", vbecommadnum(2, vbecommadtotplay), vbecommadnum(4, vbecommadtotplay)
End Sub
Sub 執行指令_禁止執行人物主動技技能_選擇(ByVal uscom As Integer, ByVal commadtype As Integer, ByVal atkingnum As Integer)
    If Formsetting.checktest.Value = 0 Then On Error GoTo vss_cmdlocalerr
    commadstr3 = Split(vbecommadstr(3, vbecommadtotplay), ",")
    If UBound(commadstr3) <> 3 Or (commadtype <> 1 And vbecommadnum(4, vbecommadtotplay) <> 61) Or atkingnum <= 8 Then GoTo VssCommadExit
    Select Case vbecommadnum(2, vbecommadtotplay)
        Case 1
            Select Case Val(commadstr3(0))
                 Case 1
...
Exit Sub
vss_cmdlocalerr:
執行指令集.執行指令集_錯誤訊息通知 "PersonAtkingOffSelect", vbecommadnum(2, vbecommadtotplay), vbecommadnum(4, vbecommadtotplay)
End Sub
Sub 執行指令_禁止執行人物被動技技能_選擇(ByVal uscom As Integer, ByVal commadtype As Integer, ByVal atkingnum As Integer)
    If Formsetting.checktest.Value = 0 Then On Error GoTo vss_cmdlocalerr
    commadstr3 = Split(vbecommadstr(3, vbecommadtotplay), ",")
    If UBound(commadstr3) <> 3 Or (commadtype <> 1 And vbecommadnum(4, vbecommadtotplay) <> 61) Or atkingnum <= 8 Then GoTo VssCommadExit
    Select Case vbecommadnum(2, vbecommadtotplay)
...
Exit Sub
vss_cmdlocalerr:
執行指令集.執行指令集_錯誤訊息通知 "PersonPassiveOffSelect", vbecommadnum(2, vbecommadtotplay), vbecommadnum(4, vbecommadtotplay)
End Sub
...
Sub 執行指令_移動前總移動量控制(ByVal uscom As Integer, ByVal commadtype As Integer, ByVal atkingnum As Integer)
    If Formsetting.checktest.Value = 0 Then On Error GoTo vss_cmdlocalerr
    commadstr3 = Split(vbecommadstr(3, vbecommadtotplay), ",")
    If UBound(commadstr3) <> 2 Or (vbecommadnum(4, vbecommadtotplay) <> 70 And vbecommadnum(4, vbecommadtotplay) <> 71) Then GoTo VssCommadExit
    Dim uscomt As Integer
    Select Case Val(commadstr3(0))
         Case 1
               uscomt = uscom
